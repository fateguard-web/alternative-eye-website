...
export function NewsCard({ date, title, description, href }: NewsCardProps) {
  return (
    <motion.div
      ...
      className="bg-[#111] border border-[#222] transition-all duration-300 hover:-translate-y-2 hover:border-[#333]"
    >
      ...
      <div className="p-6">
        ...
        <a
          href={href}
          className="inline-block mt-4 text-white no-underline font-semibold border-b border-[#ff0000] hover:text-[#ff0000] transition-colors"
        >
          Read More
        </a>
      </div>
